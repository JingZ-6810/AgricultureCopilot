...
class PaperDigest:
    '''
    Compress information for each chunk
    text summarization
    embedding
    etc.
    '''
    ...
    def get_best_doc(self,query:str):
        docs = self.vector_store.similarity_search(query=query, k=3) # get top 3 most similar docs
        return docs
    ...
    def load_from_local(store_path: str):
        if os.path.exists(store_path):
            ...
            raise FileNotFoundError(f"No file: {store_path}")
